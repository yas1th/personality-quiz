...
export const questionActionCreators = {
    ...
    fetchQuestionsSuccess: (data) => ({type: questionsActions.FETCH_QUESTIONS_SUCCESS, payload: data}),
    fetchQuestionsError: (data) => ({type: questionsActions.FETCH_QUESTIONS_ERROR, payload: data})
}